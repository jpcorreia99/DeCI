...
func main() {
	...
	neighbour := flag.String("neighbour", "", "Address of known neighbour.")
	...
	if *isCentral {
		centralNode := createPeer("127.0.0.1:0")
	...
	if *neighbour == "" && !*isCentral {
		println("Please provide a neighbour address")
		return
	}
	...
	myNode.AddPeer(*neighbour)

	err = myNode.JoinNetwork(*neighbour)
